...
public class PseudoQueueTest {
    ...
    public void enqueue() {
        ...
        test.enqueue("top");
        assertEquals("Top value should be the newest value.", "top", test.inStack.getTop());

        test.enqueue("second");
        test.enqueue("first");
        assertEquals("Top value should be the newest value.", "first", test.inStack.getTop());
    }

    @Test
    public void dequeue() {
        PseudoQueue test = new PseudoQueue();
        test.enqueue("removeMe");
        assertEquals("Should return the oldest value.", "removeMe", test.dequeue());
