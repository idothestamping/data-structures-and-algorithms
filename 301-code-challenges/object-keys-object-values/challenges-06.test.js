...
const hasChildrenEntries = (arr, character) => {
  ...
  arr.forEach(obj => {
    if(Object.entries(obj)[0][1] === character){
      if(Object.entries(obj)[2][1].length){
        flag = true;
      }
    }
  });
...
const totalCharacters = (arr) => {
  ...
  arr.forEach(obj => {
    ...
    if(Object.values(obj)[2].length){
      counter += Object.values(obj)[2].length;
    }
...
const houseSize = (arr) => {
  ...
  arr.forEach(obj => {
    ...
    sizes.push({house: Object.values(obj)[3], members: counter});
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach(obj => {
    ...
    if(!(deceasedSpouses.includes(Object.values(obj)[1])) && (Object.values(obj)[1])){
      counter += 1;
    }
    ...
    survivors.push({house: Object.values(obj)[3], members: counter});
